...
module.exports = async function() {
  var users = ['amateseru','marco8641','Bonooru_','tob3000','Exodus122','Juwk','hyperion64','runnerguy2489','realtimeattack64','phoenixfeather1','scaramangado','psymarth','blinkzy','gregortixlkyns','chris7m','jenslang','gombill','gombill','dannyb21892','flofloo2217','mrbubbleskp','armorysons','flanthis','acermax','adefgames','xanra','sonfloro','bou_frost','oxxyga','thecowness','alaris_villain','doctorkillmd','menou_','thiefbug','TitouKay','MarshallObob','kintefleush','ziranui','matttinthehat','moosecrap','mrjabujabu','elsloth90','blancalamb','aliensqueakytoy','seadan','luigidude851','Tasslehoff9566','quickkiran','nkitten','silentknight115','trisscorp','fig02','letsklay','f1gure8','remidemmi','numberplay','coffeerunner1','cosmia_','metaknight3000','nonsensebread','kaylabee17','optimusprimemini','jolin012','fenyan','sanzeau','lauren07','cook99999','revivaal_','akalster','kpl389','nupperz_','SeedBorn','finappie','bloodduster','zemorn','Mephisto_DCIX','sjorec','spamminn','mrcodgrim','gmanxxxx','ostrealava02','Lance47','linky628','spoo3','crimtab','smokercb','tenari_iranet','rosewater0','THags15','mindezzy','DLH112','woawkoaw','teh_squirrel','wannabe_weeb99','arandomclown','arontoad99','sniping117','piti','giuocob','spleff'];
