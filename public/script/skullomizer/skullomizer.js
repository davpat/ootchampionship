...
function update_values() {
	...
	document.getElementById("image_1").innerHTML = '<img src="images/skullomizer/img/'+String(skull_numbers[0] + 1)+'.jpg" class="image-preview">';
	document.getElementById("image_2").innerHTML = '<img src="images/skullomizer/img/'+String(skull_numbers[1] + 1)+'.jpg" class="image-preview">';
	document.getElementById("image_3").innerHTML = '<img src="images/skullomizer/img/'+String(skull_numbers[2] + 1)+'.jpg" class="image-preview">';
	document.getElementById("image_4").innerHTML = '<img src="images/skullomizer/img/'+String(skull_numbers[3] + 1)+'.jpg" class="image-preview">';
	document.getElementById("image_5").innerHTML = '<img src="images/skullomizer/img/'+String(skull_numbers[4] + 1)+'.jpg" class="image-preview">';
